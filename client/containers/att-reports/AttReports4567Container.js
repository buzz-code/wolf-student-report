...
const getColumns = ({ students, studentTypes }) => [
  ...
  { field: 'excellencyHomework', title: 'האם מסרת מטלה שבועית' },
  { field: 'phoneDiscussing', title: 'האם ערכתן דיון על הכיתה' },
  { field: 'openQuestion', title: 'האם נהנית בצפיה' },
];
...
const AttReports4567Container = ({ entity, title }) => {
...
export default AttReports4567Container;
